      ...
      <div className="items-center text-center pt-2 text-white">
        ...
        {clienteNome == '' ? (
          <Link href="/login" className="text-white">
            <h4 className="font-bold text-xl rounded-xl p-2 transition duration-300 ease-out hover:text-violet-950 hover:bg-white">
              Login
            </h4>
          </Link>
        ) : (
          <div
            href="/login"
            className="font-bold text-xl rounded-xl p-2 transition duration-300 ease-out hover:text-violet-950 hover:bg-white"
            onClick={logout}
          >
