...
export default function Header() {
    ...
    function Menu() {
        ...
        <div className="items-center text-center pt-2 text-white">   
            <Link href="#">
                <div className="font-bold text-xl  bg-zinc-900 rounded-xl p-2 transition duration-300 ease-out hover:text-zinc-300 hover:bg-slate-800">Home</div>
            </Link>
            <Link href="services">
                <div className="font-bold text-xl  bg-zinc-900 rounded-xl p-2 transition duration-300 ease-out hover:text-zinc-300 hover:bg-slate-800">Serviços</div>
            </Link>
            <Link href="#">
                <div className="font-bold text-xl  bg-zinc-900 rounded-xl p-2 transition duration-300 ease-out hover:text-zinc-300 hover:bg-slate-800">Produtos</div>
            </Link>
            <Link href="#">
                <div className="font-bold text-xl  bg-zinc-900 rounded-xl p-2 transition duration-300 ease-out hover:text-zinc-300 hover:bg-slate-800">Agenda</div>
            </Link>
        </div>
        )
    }
