      ...
      <div className=" bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 ">
        <div className="flex h-full mx-auto max-w-[1246px] pl-4 pr-4 pb-4 md:pt-4">
          <div className="grid md:grid-cols-2 sm:grid-cols-1 items-center justify-items-center">
            <div className="p-4">
              <img
                className=" md:h-[400px] h-[200] border-[15px] rounded-full border-r-slate-800 "
            ...
            <div className="text-slate-800 p-4 border-2 border-opacity-100 rounded-xl shadow-xl">
              ...
              <p className="text-white text-lg">
                Meu nome ELIANE SIEFERT sou graduada em Enfermagem, Pedagogia e
                Massoterapeuta. Sou especialista em Massoterapia e tenho como
                objetivo tornar o momento da massagem uma forma acessível e
                necessária para a saúde mental, física e bem- estar de quem
